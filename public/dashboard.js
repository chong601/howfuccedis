...
NETDATA.jQuery = netdataAssets + '/' + 'lib/jquery-3.6.0.min.js';
NETDATA.peity_js = netdataAssets + '/' + 'lib/jquery.peity-3.2.0.min.js';
NETDATA.sparkline_js = netdataAssets + '/' + 'lib/jquery.sparkline-2.1.2.min.js';
NETDATA.easypiechart_js = netdataAssets + '/' + 'lib/jquery.easypiechart-97b5824.min.js';
NETDATA.gauge_js = netdataAssets + '/' + 'lib/gauge-1.3.2.min.js';
NETDATA.dygraph_js = netdataAssets + '/' + 'lib/dygraph-c91c859.min.js';
NETDATA.dygraph_smooth_js = netdataAssets + '/' + 'lib/dygraph-smooth-plotter-c91c859.js';
// NETDATA.raphael_js          = netdataAssets + '/' + 'lib/raphael-2.2.4-min.js';
// NETDATA.c3_js               = netdataAssets + '/' + 'lib/c3-0.4.18.min.js';
// NETDATA.c3_css              = netdataAssets + '/' + 'css/c3-0.4.18.min.css';
NETDATA.d3pie_js = netdataAssets + '/' + 'lib/d3pie-0.2.1-netdata-3.js';
NETDATA.d3_js = netdataAssets + '/' + 'lib/d3-4.12.2.min.js';
// NETDATA.morris_js           = netdataAssets + '/' + 'lib/morris-0.5.1.min.js';
// NETDATA.morris_css          = netdataAssets + '/' + 'css/morris-0.5.1.css';
...
NETDATA.themes = {
    white: {
        bootstrap_css: netdataAssets + '/' + 'css/bootstrap-3.3.7.css',
        dashboard_css: netdataAssets + '/' + 'dashboard.css',
        background: '#FFFFFF',
        foreground: '#000000',
        grid: '#F0F0F0',
        axis: '#F0F0F0',
    ...
    slate: {
        bootstrap_css: netdataAssets + '/' + 'css/bootstrap-slate-flat-3.3.7.css?v20161229-1',
        dashboard_css: netdataAssets + '/' + 'dashboard.slate.css?v20190902-0',
        background: '#272b30',
        foreground: '#C8C8C8',
        grid: '#283236',
        axis: '#283236',
...
NETDATA.requiredJs = [
    {
        url: netdataAssets + '/' + 'lib/bootstrap-3.3.7.min.js',
        async: false,
    ...
    {
        url: netdataAssets + '/' + 'lib/fontawesome-all-5.0.1.min.js',
        async: true,
        isAlreadyLoaded: function () {
    ...
    {
        url: netdataAssets + '/' + 'lib/perfect-scrollbar-0.6.15.min.js',
        isAlreadyLoaded: function () {
            return false;
        }
    }
